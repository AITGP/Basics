CREATE OR REPLACE PACKAGE BODY ECOOPDESA.PK_AMANDASOFT_PLUGINS AS
    ...
    RETURN APEX_PLUGIN.T_DYNAMIC_ACTION_RENDER_RESULT IS
		...
		L_DATA_SOURCES	 							VARCHAR2(32000) 	:= P_DYNAMIC_ACTION.ATTRIBUTE_04;
